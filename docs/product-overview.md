...
### 3. Dịch clipboard (`⌃+⌥+V`)
**Dùng khi:** Đã copy text, muốn dịch nhanh.
```
⌘+C copy text → ⌃+⌥+V → popup hiện bản dịch → "Replace & Paste" paste luôn bản dịch
```

### 4. Dịch thủ công (click menu bar)
...
- **AI Translation** — GPT-4o-mini (mặc định), Claude Sonnet (tùy chọn)
